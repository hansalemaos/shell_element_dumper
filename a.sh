        ...
        for element in "${output_array_index[@]}"; do
            ...
            for element1 in "${output_array_index[@]}"; do
                ...
                if [ "$indexrevcounter" -eq "$reversecounterchecker" ]; then
                    ...
                    printf "%s\t" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((IS_ACTIVE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((ELEMENT_INDEX))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((START_X))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((START_Y))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((CENTER_X))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((CENTER_Y))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((AREA))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((END_X))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((END_Y))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((WIDTH))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((HEIGHT))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((START_X_RELATIVE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((START_Y_RELATIVE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((END_X_RELATIVE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((END_Y_RELATIVE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PARENTSINDEX))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((ELEMENT_ID))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((MID))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((HASHCODE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((VISIBILITY))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((FOCUSABLE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((ENABLED))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((DRAWN))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((SCROLLBARS_HORIZONTAL))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((SCROLLBARS_VERTICAL))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((CLICKABLE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((LONG_CLICKABLE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((CONTEXT_CLICKABLE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((CLASSNAME))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_IS_ROOT_NAMESPACE))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_FOCUSED))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_SELECTED))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_PREPRESSED))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_HOVERED))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_ACTIVATED))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_INVALIDATED))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((PFLAG_DIRTY_MASK))))]}" "${array_elements[$((element_index * $((ARRAY_WIDTH)) + $((LINE_STRIPPED))))]}"  | echo "$(cat)"  >> /sdcard/a.txt
...
printf "%s\t" "IS_ACTIVE" "ELEMENT_INDEX" "START_X" "START_Y" "CENTER_X" "CENTER_Y" "AREA" "END_X" "END_Y" "WIDTH" "HEIGHT" "START_X_RELATIVE" "START_Y_RELATIVE" "END_X_RELATIVE" "END_Y_RELATIVE" "PARENTSINDEX" "ELEMENT_ID" "MID" "HASHCODE" "VISIBILITY" "FOCUSABLE" "ENABLED" "DRAWN" "SCROLLBARS_HORIZONTAL" "SCROLLBARS_VERTICAL" "CLICKABLE" "LONG_CLICKABLE" "CONTEXT_CLICKABLE" "CLASSNAME" "PFLAG_IS_ROOT_NAMESPACE" "PFLAG_FOCUSED" "PFLAG_SELECTED" "PFLAG_PREPRESSED" "PFLAG_HOVERED" "PFLAG_ACTIVATED" "PFLAG_INVALIDATED" "PFLAG_DIRTY_MASK" "LINE_STRIPPED" | echo "$(cat)"  > /sdcard/a.txt
execute_all
unset INDEX_ARRAY
