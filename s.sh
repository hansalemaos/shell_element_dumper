...
printf "%s\t" "IS_ACTIVE" "ELEMENT_INDEX" "START_X" "START_Y" "CENTER_X" "CENTER_Y" "AREA" "END_X" "END_Y" "WIDTH" "HEIGHT" "START_X_RELATIVE" "START_Y_RELATIVE" "END_X_RELATIVE" "END_Y_RELATIVE" "PARENTSINDEX" "ELEMENT_ID" "MID" "HASHCODE" "VISIBILITY" "CLICKABLE" "CLASSNAME" "LINE_STRIPPED" | echo "$(cat)"  > /sdcard/s.txt
execute_all
unset INDEX_ARRAY
